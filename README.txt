...
SETUP
-----
1. Open WordClock.ino in Arduino IDE.
2. Board: "ESP32 Dev Module" (or TTGO T7 v1.4 for Watchy v2+)
   via: https://raw.githubusercontent.com/espressif/arduino-   esp32/gh-pages/package_esp32_index.json
3. Install the Watchy library via Arduino Library Manager.
4. Enter bootloader: hold Back+Up 5 s → release Back first → release Up.
5. Select the new COM port. Upload.
...
--------
  ...
  • Nighttime blackout  00:00–07:00  (change SLEEP_FROM/SLEEP_UNTIL)
